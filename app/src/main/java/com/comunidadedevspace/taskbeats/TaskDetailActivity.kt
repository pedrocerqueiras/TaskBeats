...
class TaskDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val edtTitle = findViewById<EditText>(R.id.edt_text_title)
        val edtDescription = findViewById<EditText>(R.id.edt_text_description)
    ...
    private fun returnAction(task: Task, actionType: ActionType){
        ...
        setResult(Activity.RESULT_OK, intenet)
        finish()
    }
